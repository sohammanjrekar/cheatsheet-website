<?php require_once 'Navbar.php'?>
    ...
    <nav class="mt-5 pt-1">
        <div class="text-center " style="font-size: 5vh; font-weight: 900;padding-top:2vh">
            <img src="../img/html.svg" alt="" /> HTML cheatsheet
        </div>
    </nav>
    <div class="container">
        <div class="p-5 mb-4 bg-light rounded-3 jumbo mt-2">
            <div class="container-fluid py-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img src="../img/html.svg" alt="" style="width:100% ;" />
                    </div>
                </div>
        ...
        <ol>
            <!-- offcanvas -->
            <li>
                starter template<button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o2" aria-controls="o2">
          Read More...
        </button>
...
&lt;address&gt;             &lt;/address&gt;                  
            ...
            <!-- offcanvas -->
            <li>
                HTML Attributes<button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o22" aria-controls="o22">
          Read More...
        </button>
            ...
            <li>
                HTML Core Attributes<button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o23" aria-controls="o23">
          Read More...
        </button>
            ...
            <li>
                HTML Internationalization Attributes<button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o24" aria-controls="o24">
          Read More...
        </button>
            ...
            <li>
                HTML Generic Attributes<button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o25" aria-controls="o25">
          Read More...
        </button>
                    ...
                    The “src” Attribute
                                ...
                                <div id="c9" class="accordion-collapse collapse" aria-labelledby="h9" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <ol>
                                            <li> Absolute path: This path contains the path of the external content.</li>
            ...
            <li>
                HTML Links
                <button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o26" aria-controls="o26">
          Read More...
        </button>
                <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="o26" aria-labelledby="offcanvasWithBothOptionsLabel">
                    ...
                    Link Colors
                                ...
                                <div id="c7" class="accordion-collapse collapse" aria-labelledby="h7" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        Three types of links are there: <span style="color: red;"> active</span>, <span style="color: purple;">visited</span>, and<span style="color:blue;"> unvisited.</span>
                                        <br>
                                        <ul>
                                            <li>
                                                Active: It is in <span style="color: red;"> red</span> with an underline.</li>
                                            <li>
                                                Visited: It is <span style="color: purple;">purple</span> and underlined.</li>
                                            <li>
                                                Unvisited: It is <span style="color:blue;">blue</span> and underlined.</li>
                                        </ul>
          ...
          &lt; href= "Your specified path" &gt;             &lt;/a&gt;
            ...
            <li>
                HTML Comments
                <button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o27" aria-controls="o27">
          Read More...
        </button>
                    ...
                    <div class="offcanvas-body">
                        <p>HTML Comments<br>
                            <ul>
                                ...
                                <li>Shortcut Keys are "Ctrl + /" . This will automatically put our selected content as a comment</li>
        ...
        --&gt;
            ...
            <li>
                HTML Images
                <button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o28" aria-controls="o28">
          Read More...
        </button>
          ...
          &lt;img src="images/profile_pic" alt="Testing Image" /&gt;
            ...
            <li>
                HTML Lists
                <button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o29" aria-controls="o29">
          Read More...
        </button>
                <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="o29" aria-labelledby="offcanvasWithBothOptionsLabel">
                    ...
                    An Unordered List
                                ...
                                <div id="c4" class="accordion-collapse collapse" aria-labelledby="h4" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        This list will list items using bullets. <br> Unordered lists have no sequence. <br> They are more like bullet points.
          ...
          &lt;dl&gt;
            ...
            <li>
                HTML Tables
                <button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o210" aria-controls="o210">
          Read More...
        </button>
        ...
        &lt;/table&gt;
            ...
            <li>
                HTML Block Elements
                <button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o211" aria-controls="o211">
          Read More...
        </button>
                <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="o211" aria-labelledby="offcanvasWithBothOptionsLabel">
                    ...
                    <div class="offcanvas-body">
                        You already know about tags all those tags have some displaying value i.e. Either they are block-level elements or they are Inline elements. <br> Now, let's discuss block-level elements. <br> Block-level elements are those elements
            ...
            <li>
                ...
                <button class="btn btn-primary mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#o212" aria-controls="o212">
          Read More...
        </button>
