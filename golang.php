<?php require_once 'Navbar.php'?>
    ...
    <nav class="mt-5 p-2 headline" style="background:linear-gradient(to top right, #fb5475 0%, #f77b50 59%);">
        <div class="text-center " style="margin-top:5vh;"><img style="margin-right:2vh;"
                src="../../assets/img/go-seeklogo.svg" alt="" /> Go Lang cheatsheet
        </div>
    </nav>
    <div class="container">
        <div class="p-5 mb-4 bg-light rounded-3 jumbo mt-2">
            <div class="container-fluid py-3">
                <h1 class="display-5 fw-bold">Go Lang</h1>
                <div class="row">
                    <div class="col-md-6">
                        <p class="fs-4">
                    ...
                    <div class="col-md-6 text-center">
                        <img src="../../assets/img/go-seeklogo.svg" alt="" style="height:100%;width:100%;" />
                    </div>
                </div>
        ...
        <ol>
            <!-- offcanvas -->
            <li>
            Go backend File Structure<button class="btn btn1" type="button" data-bs-toggle="offcanvas"
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasBottom2"
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasBottomLabel">Go backend File Structure</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
